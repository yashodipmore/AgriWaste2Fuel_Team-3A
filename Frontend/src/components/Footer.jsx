  ...
  return (
    <footer className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-emerald-500/20 to-cyan-500/20"></div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-gray-300 mb-6 max-w-md leading-relaxed">
                Transforming agricultural waste into sustainable energy solutions through AI-powered analysis. 
                Building a greener future for farming communities worldwide.
              </p>
              <div className="flex space-x-4">
                ...
                <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer"
                   className="w-10 h-10 bg-gray-700 hover:bg-blue-800 rounded-lg flex items-center justify-center transition-colors duration-200">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link to="/input" className="text-gray-300 hover:text-emerald-400 transition-colors duration-200">Analysis</Link></li>
                <li><Link to="/about" className="text-gray-300 hover:text-emerald-400 transition-colors duration-200">About</Link></li>
                <li><a href="https://docs.agritech.com" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-emerald-400 transition-colors duration-200">Documentation</a></li>
              </ul>
            </div>
